                ...
                <Sidebar />
                    ...
                    <div className='text-zone'>
                        ...
                        <div className='Flutter'>
                            <a href='https://flutter-6kk2.onrender.com'><img className='butterfly' src={FlutterLogo} /></a>
                                <br/><br/><br/>
                            <a href='https://flutter-6kk2.onrender.com'><p className='Flutter-title'>Flutter</p></a>
                            <text className='technologies'> 
                                    <ul>
                                        <li>Python</li>
                                        <li>Flask</li>
                            ...
                            <p>Flutter is a Twitter clone, created in conjunction with Springboard's Software Engineering Career Track.</p> 
                        </div>
